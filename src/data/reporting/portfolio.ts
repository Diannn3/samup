...
export const PORTFOLIO_ITEMS: PortfolioItem[] = [
  ...
  },
  {
    ...
    details: "Conducted on-the-ground interviews capturing the daily lived experiences, economic pressures, and transit realities of jeepney drivers in Los Baños. Synthesized complex community stories into an empathetic, high-engagement social media video series."
  },
  {
    id: "nimp-2027",
    ...
    aspectRatio: "1:1",
    featured: true,
    caption: "Full promotional identity and social countdown system for the nationwide junior high competition.",
    details: "Co-engineered the visual language for NIMP 2027. Created the Hanayan ng Isipan master theme, official competition countdown releases, primer layout standards, and participant announcement graphics designed to inspire school pride across the country."
  },
  {
    id: "mia-2027",
    ...
    details: "Developed the editorial system for MIA 2027, including registration headers, participant certificate layouts, speaker placards, tarpaulin specifications, and social media countdown materials."
  },
  {
    id: "open-tambayan",
    ...
    details: "Designed vibrant community-invitation graphics and handled technical setup for the semester-opening tambayan, driving member engagement and student community discovery."
  },
  {
    ...
    details: "Comprehensive documentary photography of the first semester organization orientation, establishing Dian's reputation for dependable creative execution and prompt delivery."
  },
  {
    id: "razzmatazz-2026",
    ...
    details: "External affiliation contribution designing high-impact social teasers and promotional assets for major university events."
  },
  {
    ...
    details: "Active involvement maintaining open-source digital infrastructure for the UPLB student body, blending applied software architecture with clear civic UX."
  }
];
