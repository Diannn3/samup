...
export const STATIONS: Station[] = [
  {
    ...
    description: "Welcome. This reporting is a conversation, not a lecture. I introduce myself, you introduce yourself, I share my journey in SAM-UP, and we talk about how we can build together.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Joined SAM-UP under Batch Florensimus Vincula. Starting out as the photographer for the 1st Semester Organization Orientation, diving immediately into visual documentation and org life.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Business Committee is Dian's constitutional standing committee. It manages SAM-UP's external affairs, public relations, event documentation, and publication systems.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Dispelling the misconception that Marketing is only about partnerships. SAM-UP Marketing has two distinct, equally vital wings: Partnership and Promotions.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Serving as Marketing Deputy Head for two semesters (2nd Sem 25-26 and 1st Sem 26-27). The Auditor coordinates with Execom and verifies direction; Dian manages tactical execution.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Dian's proudest creative achievement in SAM-UP. A high-production short cinematic documentary proving how Applied Mathematics breathes inside everyday Philippine reality.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Stepping out of the classroom to capture real stories. Dian led videography and interviews with jeepney drivers in Laguna for the ENABLE 2026 initiative.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Large-scale institutional event packaging for high school and university mathematics competitions spanning the entire Philippines.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "Dian's leadership thesis. Derived from experience: ambiguous delegation causes burnout; clear communication creates mastery.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "The line stops being about Dian. Now it is your turn. Dian listens to who you are, what drives you, and what makes you happy.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "This is the heart of the reporting. Not an interrogation, but an honest conversation about what you are seeking and what you hope to give back to this community.",
    bulletPoints: [
  ...
  },
  {
    ...
    description: "My path in SAM-UP is drawn. Yours is completely open. Welcome to the Society of Applied Mathematics of UPLB.",
    bulletPoints: [
